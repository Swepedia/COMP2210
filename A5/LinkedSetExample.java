...
/**
 * LinkedSetExample.java
 * Illustrates the effect of the LinkedSet methods.
 *
...
public class LinkedSetExample {
   ...
   public static void main(String[] args) {
      ...
      LinkedSet<Integer> s1 = new LinkedSet<Integer>();
      for (int i = 0; i < 5; i++) {
         s1.add(i);
      }
      ...
      LinkedSet<Integer> s2 = new LinkedSet<Integer>();
      for (int i = 4; i >= 0; i--) {
         s2.add(i);
      }
      ...
      LinkedSet<Integer> s3 = new LinkedSet<Integer>();
      s3.add(-5);
      s3.add(1);
      s3.add(0);
      s3.add(-1);
